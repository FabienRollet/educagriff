...
async function seedQuestions() {
  try {
    ...
    await prisma.question.create({
      data: {
        id: 1,
        text: "Vous recherchez de l'aide pour",
        options: {
          create: [
            {
              text: "Votre chien",
    ...
    await prisma.question.create({
      data: {
        id: 8,
        text: "Vous cherchez de l'aide pour",
        options: {
          create: [
            {
    ...
    await prisma.question.create({
      data: {
        id: 9,
        text: "Vous avez des problèmes pour",
        options: {
          create: [
            {
    ...
    await prisma.question.create({
      data: {
        id: 11,
        text: "Depuis quand datent les problèmes d'agressivité ?",
        options: {
          create: [
            {
    ...
    await prisma.question.create({
      data: {
        id: 12,
        text: "Quel est le type d'agressivité",
        options: {
          create: [
            {
    ...
    await prisma.question.create({
      data: {
        id: 14,
        text: "Les changements de comportement sont",
        options: {
          create: [
            {

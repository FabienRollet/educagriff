      ...
      {[
        {
          ...
          services: [
            ...
            ["Balade éducative 1h", "20€","Les balades éducatives pour chiens combinent une sortie hygiénique de 30 minutes et un accompagnement éducatif personnalisé. Ce service permet de consolider les acquis et de renforcer les comportements en cours d’apprentissage, favorisant ainsi une progression continue et un équilibre optimal pour votre chien."],

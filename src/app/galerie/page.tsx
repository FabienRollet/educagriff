          ...
          {photos.map((photo) => (
            ...
            >
              <div className="relative w-full h-64">
                {photo.url.match(/\.(mp4|webm|ogg)$/i) ? (
                  <video
                    src={photo.url}
                    className="object-cover w-full h-full rounded-lg pointer-events-none select-none opacity-90"
                    muted
                    playsInline
                    preload="metadata"
                  />
        ...
        >
          <div className="relative max-w-4xl w-full">
            ...
            <div className="relative h-[80vh]">
              {selectedPhoto.url.match(/\.(mp4|webm|ogg)$/i) ? (
                <video
